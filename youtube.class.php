...
class YouTube {
	...
	public function EmbedVideo($url = null, $width = 425, $height = 344, $id="ytplayer") {
		if ($url == null)
			$videoid = $this->id;
		else
		{
		...
		return '<object id="'.$id.'" width="'.$width.'" height="'.$height.'"><param name="movie" value="http://www.youtube.com/v/'.$videoid.'?rel=0&fs=1&loop=0&enablejsapi=1&version=3"></param><param name="wmode" value="transparent"></param><param name="allowFullScreen" value="true"><embed src="http://www.youtube.com/v/'.$videoid.'?rel=0&fs=1&loop=0" allowfullscreen="true" type="application/x-shockwave-flash" wmode="transparent" width="'.$width.'" height="'.$height.'"></embed></object>';
	}
	...
	public function ShowImg($width=150, $height= 100, $url = null, $imgid = 1, $alt = 'Video screenshot') {
		return "<img src='".$this->GetImgURL($url, $imgid)."' width='".$width."' height='".$height."' border='0' alt='".$alt."' title='".$alt."' />";
	}
